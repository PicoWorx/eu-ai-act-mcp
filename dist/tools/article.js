import { articleInputSchema, articleOutputSchema, } from "../schemas/article.js";
import { articles, findArticle, EURLEX_BASE_URL } from "../knowledge/articles.js";
export function registerArticleTool(server) {
    server.registerTool("euaiact_get_article", {
