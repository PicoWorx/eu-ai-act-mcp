...
export function registerArt6ExceptionTool(server) {
    server.registerTool("euaiact_assess_art6_3_exception", {
        ...
        const noSignificantRiskAssessed = input.no_significant_risk_to_health_safety_fundamental_rights === true;
        let exceptionAvailable;
        let reasoning;
        if (profilingBlocks) {
        ...
        const output = {
            ...
            registration_duty: "Art. 49(2): Providers relying on the Art. 6(3) exception must still register themselves and the system in the EU database, indicating the reliance on Art. 6(3).",
...
//# sourceMappingURL=art6-exception.js.map