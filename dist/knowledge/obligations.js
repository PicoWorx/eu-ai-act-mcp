...
export const providerHighRiskObligations = [
    ...
    },
    {
        ...
        deadline: "2026-08-02",
        details: "High-risk AI systems must technically allow for automatic recording of events (logs) throughout the system's lifetime under Art. 12. Providers must keep automatically generated logs to the extent they are under the provider's control under Art. 19, for a period appropriate to the intended purpose and at least 6 months unless applicable Union or national law provides otherwise.",
        category: "documentation",
    },
    {
...
export const deployerHighRiskObligations = [
    ...
    },
    {
        ...
        article: "Art. 26(7)",
        deadline: "2026-08-02",
        details: "Before putting into service or using a high-risk AI system at the workplace, deployers who are employers must inform workers' representatives and affected workers that they will be subject to use of the high-risk AI system, in accordance with applicable Union and national worker-information rules.",
        category: "transparency",
    },
    {
        ...
        article: "Art. 26(11)",
        deadline: "2026-08-02",
        details: "Deployers of high-risk AI systems referred to in Annex III that make decisions or assist in making decisions related to natural persons must inform the natural persons that they are subject to the use of the high-risk AI system. For law-enforcement uses, Art. 13 of Directive (EU) 2016/680 applies.",
        category: "transparency",
    },
    {
...
export const providerGPAIObligations = [
    ...
    },
    {
        ...
        article: "Art. 53(1)(d)",
        deadline: GPAI_STANDARD_DEADLINE,
        details: `Draw up and make publicly available a sufficiently detailed summary of the content used for training the GPAI model, according to a template provided by the AI Office. Standard deadline: ${GPAI_STANDARD_DEADLINE}; for GPAI models placed on the market before 2025-08-02, Art. 111(3) gives providers until ${GPAI_LEGACY_TRANSITION_DEADLINE}.`,
        category: "transparency",
    },
    {
...
// ---------------------------------------------------------------------------
export const providerLimitedRiskTransparencyObligations = [
    {
    ...
    },
    {
        ...
        article: "Art. 50(2)",
        deadline: "2026-08-02",
        details: "Providers of AI systems generating synthetic audio, image, video, or text content must ensure the outputs are marked in a machine-readable format and detectable as artificially generated or manipulated. Technical solutions must be effective, interoperable, robust, and reliable, considering the type of content and commonly used implementation methods and tools.",
        category: "transparency",
    },
];
export const deployerLimitedRiskTransparencyObligations = [
    {
        obligation: "Inform persons exposed to emotion recognition or biometric categorisation",
        article: "Art. 50(3)",
        deadline: "2026-08-02",
        details: "Deployers of emotion recognition or biometric categorisation systems must inform exposed natural persons of the system's operation and process personal data in accordance with the GDPR, LED, and Regulation (EU) 2018/1725 as applicable.",
        category: "transparency",
    },
    {
