 ...
 */
export const annexIVItems = [
    {
        number: 1,
        title: "General description of the AI system",
        description: "A general description of the AI system including its intended purpose, the person or entity placing it on the market, its version, how it interacts with or can be used to interact with hardware or software, and how it generates its outputs.",
        sub_items: [
    ...
    },
    {
        ...
        description: "A detailed description of the elements of the AI system and of the process for its development, including: methods and steps performed, key design choices, main classification choices, training methodologies and techniques used, and where relevant, data requirements.",
        sub_items: [
    ...
    },
    {
        ...
        description: "Detailed information about the monitoring, functioning, and control of the AI system, in particular with regard to its capabilities and limitations in performance, expected levels of accuracy, foreseeable unintended outcomes, and specific risks.",
        sub_items: [
    ...
    },
    {
        ...
        description: "A detailed description of the risk management system in accordance with Art. 9.",
        sub_items: [
    ...
    },
    {
        ...
        description: "A copy of the EU declaration of conformity referred to in Art. 47.",
        sub_items: [
    ...
    },
    {
        ...
        description: "A detailed description of the system in place to evaluate the AI system performance in the post-market phase in accordance with Art. 72, including the post-market monitoring plan referred to in Art. 72(3).",
        sub_items: [
