...
export const art6ExceptionInputSchema = z.object({
    ...
    performs_profiling: z
        .boolean()
        .describe("Does the system perform profiling of natural persons? If true, Art. 6(3) exception is UNAVAILABLE regardless of other conditions (Art. 6(3) second subparagraph)."),
