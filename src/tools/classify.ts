...
function buildResult(fields: Partial<ClassifyOutput> & Pick<ClassifyOutput, "risk_classification" | "confidence" | "relevant_articles" | "obligations_summary">): ClassifyOutput {
  return {
